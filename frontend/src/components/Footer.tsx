      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 flex flex-col md:flex-row gap-12 md:gap-0 justify-between">
        ...
        <div className="flex-1 mb-8 md:mb-0">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xl font-bold text-gray-900">code<span className="text-indigo-500">Veer</span></span>
          </div>
        ...
        <div className="flex-[2] grid grid-cols-1 sm:grid-cols-3 gap-8">
          <div>
            <div className="font-semibold text-gray-800 mb-2">Practice</div>
            <ul className="space-y-1">
              {practiceLinks.map((l) => (
                <li key={l.name}>
                  <Link href={l.href} className="text-gray-600 hover:text-blue-600 transition-colors">
                    {l.name}
                  </Link>
                </li>
              ))}
